...
MPAndroidChart \cite{website:mpandroid} es una librería totalmente open source de generación de gráficos estadísticos muy potente y sencilla de utilizar. Las gráficas que permite implementar esta librería son altamente personalizables e interactivas, y es por este motivo que se ha optado por ella para la implementación de las gráficas de barras que se muestran en la pantalla de estadísticas de las sesiones ya completadas.
